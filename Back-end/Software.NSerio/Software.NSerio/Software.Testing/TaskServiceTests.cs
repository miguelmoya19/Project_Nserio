...
public class TaskServiceTests
{
    ...
    public TaskServiceTests()
    {
        ...
        _service = new TaskServices(_taskRepositoryMock.Object,null);
    }
    ...
    [Fact]
    public void ValidateFkProjectAndDev_ShouldThrow_WhenNull()
    {
        Assert.Throws<ArgumentNullException>(() =>
            TaskValidator.ValidatorFkProjectAndDev(null, null));
    }
}